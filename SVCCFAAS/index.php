            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=facultys"></span>Faculty</a></li>
    ...
    <div class="modal-dialog modal-full-height  modal-md" role="document">
      ...
      <div class="modal-body">
        ...
        <footer class="bg-light py-5">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted">St. Vincent College of Cabuyao 2022 - <?php echo $_SESSION['setting_name'] ?> | <a href="https://www.svcc.com/" target="_blank">SVCC</a></div></div>
        </footer>
