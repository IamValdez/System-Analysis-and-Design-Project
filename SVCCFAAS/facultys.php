<?php include 'admin/db_connect.php'; 
	...
	$special = $conn->query("SELECT * FROM department_specialty");
	$ms_arr = array();
...
?>
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end mb-4 page-title">
                    	<h3 class="text-white">Faculty List</h3>
	...
	<section class="page-section" id="facultys" >
        <div class="container">
        	<div class="card">
        		<div class="card-body">
        			<div class="col-lg-12">
						...
						<div class="row">
							<div class="col-md-12 text-center">
								<?php
								$s = $conn->query("SELECT * from department_specialty where id = ".$_GET['sid'])->fetch_array()['name'];
								?>
								<h2><b> <?php echo $s ?></b></h2>
							</div>
						</div>
						<hr class="divider">
						<?php endif; ?>
				...
				$where = " where  (REPLACE(REPLACE(REPLACE(department_ids,',','\",\"'),'[','[\"'),']','\"]')) LIKE '%\"".$_GET['sid']."\"%' ";
				$cats = $conn->query("SELECT * FROM facultys_list ".$where." order by id asc");
				...
				<div class="row align-items-center">
					...
					<div class="col-md-6">
						 ...
						 <p><b>College Department:</b></p>

						 <div>
						 	<?php if(!empty($row['department_ids'])): ?>
						 	<?php 
						 	foreach(explode(",", str_replace(array("[","]"),"",$row['department_ids'])) as $k => $val): 
						 	?>
