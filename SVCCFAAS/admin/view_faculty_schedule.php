...
<?php 
	...
	$qry = $conn->query("SELECT * FROM facultys_schedule where faculty_id=".$_GET['id']);
?>
...
<script>
	$('#edit').click(function(){
		uni_modal("Edit "+$('#uni_modal .modal-title').html(),'manage_faculty_schedule.php?did=<?php echo $_GET['id'] ?>','mid-large');
	})
</script>